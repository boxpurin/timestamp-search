...
async fn main() -> AppResult<()>{
    ...
    let videos = if args.in_external {
        ...
        let channel_id = std::env::var("TSSEARCH_TARGET_CHANNEL_ID").expect("TSSEARCH_TARGET_CHANNEL_ID");
        ...
        let videos = video_fetch_service.fetch_all_videos_by_channel_id(&channel_id).await?;
